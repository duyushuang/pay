...
function init_flot_chart() {
    ...
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [[gd(2012, 1, 1), 17], [gd(2012, 1, 2), 74], [gd(2012, 1, 3), 6], [gd(2012, 1, 4), 39], [gd(2012, 1, 5), 20], [gd(2012, 1, 6), 85], [gd(2012, 1, 7), 7]], b = [[gd(2012, 1, 1), 82], [gd(2012, 1, 2), 23], [gd(2012, 1, 3), 66], [gd(2012, 1, 4), 9], [gd(2012, 1, 5), 119], [gd(2012, 1, 6), 6], [gd(2012, 1, 7), 9]], d = [], e = [[0, 1], [1, 9], [2, 6], [3, 10], [4, 5], [5, 17], [6, 6], [7, 10], [8, 7], [9, 11], [10, 35], [11, 9], [12, 12], [13, 5], [14, 3], [15, 4], [16, 9]], f = 0; f < 21; f++){ d.push([new Date(Date.today().add(f).days()).getTime(), randNum() + f + f + 10]);
		//alert(new Date(Date.today().add(f).days()).getTime() + '||||'+ (randNum() + f + f + 10));
		}
		//console.log("d",d[1]);
		if ("undefined" != typeof list_data){
			d = list_data;
		}
		//console.log("d",list_data);
	...
	//alert(d);
        ...
        $("#chart_plot_01").length && (console.log("Plot1"), $.plot($("#chart_plot_01"), [a, b], g)),
        ...
        $("#chart_plot_02").bind("plothover", function (event, pos, item) {  
            if (item) {  
                if (previousPoint != item.dataIndex) {  
                    ...
                    showTooltip(item.pageX,item.pageY, '收入：'+ y+"元<br />时间："+formatDateTime(x / 1000));  
                }  
            }  
            else {  
                $("#tooltip").remove();  
...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        var a = function() { ! 0 === $("#demo-form").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        $("parsley:field:validate",
        function() {
            a()
        ...
        var a = function() { ! 0 === $("#demo-form2").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
    ...
    if ("undefined" != typeof $.fn.cropper) {
        ...
        function() {
            ...
            if (!c.prop("disabled") && !c.hasClass("disabled") && a.data("cropper") && d.method) {
                if (d = $.extend({},
                d), "undefined" != typeof d.target && (e = $(d.target), "undefined" == typeof d.option)) try {
        ...
        l ? k.change(function() {
            var c, b = this.files;
            a.data("cropper") && b && b.length && (c = b[0], /^image\/\w+$/.test(c.type) ? (m = l.createObjectURL(c), a.one("built.cropper",
            function() {
                l.revokeObjectURL(m)
...
function init_knob() {
    if ("undefined" != typeof $.fn.knob) {
        ...
        $(".knob").knob({
            ...
            draw: function() {
                if ("tron" == this.$.data("skin")) {
                    ...
                    this.o.displayPrevious && (b = this.arc(this.v), this.g.beginPath(), this.g.strokeStyle = this.pColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, b.s, b.e, b.d), this.g.stroke()),
                    this.g.beginPath(),
        ...
        $("input.infinite").knob({
            ...
            stopper: !1,
            change: function() {
                a > this.cv ? b ? (h(), b = 0) : (b = 1, c = 0) : a < this.cv && (c ? (g(), c = 0) : (c = 1, b = 0)),
                a = this.cv
            }
        })
    }
...
function init_daterangepicker_reservation() {
    "undefined" != typeof $.fn.daterangepicker && (console.log("init_daterangepicker_reservation"), $("#reservation").daterangepicker(null,
    function(a, b, c) {
        console.log(a.toISOString(), b.toISOString(), c)
...
function init_validator() {
    "undefined" != typeof validator && (console.log("init_validator"), validator.message.date = "not a real date", $("form").on("blur", "input[required], input.optional, select.required", validator.checkField).on("change", "select.required", validator.checkField).on("keypress", "input[required][pattern]", validator.keypress), $(".multi.required").on("keyup blur", "input",
    function() {
...
function init_CustomNotification() {
    if (console.log("run_customtabs"), "undefined" != typeof CustomTabs) {
        ...
        CustomTabs();
        var b = idname = "";
        $(document).on("click", ".notification_close",
        function(a) {
...
function init_EasyPieChart() {
    if ("undefined" != typeof $.fn.easyPieChart) {
        ...
        $.fn.popover.Constructor.prototype.leave = function(a) {
            ...
            b.call(this, a),
            a.currentTarget && (d = $(a.currentTarget).siblings(".popover"), e = c.timeout, d.one("mouseenter",
            function() {
                clearTimeout(e),
                d.one("mouseleave",
                function() {
        ...
        if ($("#echart_mini_pie").length) {
            ...
            m.setOption({
                title: {
                    ...
                    sublink: "/e.weibo.com/1341556070/AhQXtjbqh",
                    x: "center",
                    y: "center",
                    itemGap: 20,
                    textStyle: {
        ...
        if ($("#echart_world_map").length) {
            ...
            n.setOption({
                ...
                tooltip: {
                    ...
                    formatter: function(a) {
                        var b = (a.value + "").split(".");
                        return b = b[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g, "$1,") + "." + b[1],
...
$.fn.popover.Constructor.prototype.leave = function(a) {
    ...
    a.currentTarget && (c = $(a.currentTarget).siblings(".popover"), d = b.timeout, c.one("mouseenter",
    function() {
        clearTimeout(d),
        c.one("mouseleave",
        function() {
