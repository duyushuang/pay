  ...
  $.cxScroll = function(){
    ...
    scroller.init = function(){
      ...
      self.api = {
        ...
        prev: function(speed,l){
          speed = parseInt(speed, 10);
          if (typeof speed !== 'number' || speed < 0) {
            speed = self.settings.speed;
          };
          self.goto(self.prevVal, speed,l);
        },
        next: function(speed,l){
          speed = parseInt(speed, 10);
          if (typeof speed !== 'number' || speed < 0) {
            speed = self.settings.speed;
          };
          self.goto(self.nextVal, speed,l);
        }
      };
    ...
    scroller.build = function(){
      ...
      self.dom.box = self.dom.el.find('.list-container');
        ...
        case 'top':
          ...
          if (d === 'left') {
            ...
            if(typeof l != 'undefined'){
              _dis = self.dom.box.scrollLeft() - l;
            }else{
