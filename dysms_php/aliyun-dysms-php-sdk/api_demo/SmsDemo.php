...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIrr3W37QYAXv3"; // AccessKeyId

        $accessKeySecret = "3PxKUOFHUmqJuZC9yi2e6dkVWNC5FT"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone, $code, $tcode = 'SMS_136020098') {
	...
	public static function sendSmslogin($phone, $tcode = 'SMS_135044765') {
	...
	public static function sendSmscash($phone, $tcode = 'SMS_135034651') {
