...
* 2015-06-29 修复签名问题
**/
require_once $tplRoot."../lib/WxPay.Config.php";
require_once $tplRoot."../lib/WxPay.Exception.php";
...
class WxPayWxMchPay extends WxPayDataBase
{
    /**
     * API 参数
     * @var array
	...
	public function values($parameter, $parameterValue)
	{
		$this->values[trim($parameter)] = trim($parameterValue);
	}
    /**
     * 生成请求xml数据
     * @return string
	...
	public function get(){
		//echo WxPayConfig::$SSLCERT_PATH.'<br />';exit;
		//echo file_exists(WxPayConfig::$SSLCERT_PATH) ? 1 : 2;exit;
		return $this->postXmlSSLCurl($this->ToXml(), $this->url);	
	}
