...
/**
 * 这个是调用bdpay_sdk里生成百度钱包PC端即时到账支付接口URL(需要登录)的DEMO
 *
 */
...
/*
$order_no = $out_trade_no;//$order_create_time . sprintf ( '%06d', rand(0, 999999));
$good_name = $out_trade_no;//$_POST['goods_name'];
$total_amount = $total_fee;//$_POST['total_amount'];
$return_url = WEB_URL."/qscms/payment/bdpay/notify_url.php";//$_POST['return_url'];//异步通知地址
$page_url   = WEB_URL."/qscms/payment/bdpay/return_url.php";//$_POST['page_url']; 
$pay_type   = '3';//$_POST['pay_type'];
$bank_no    = $payment;//$_POST['bank_no'];
$extra = $subject;//$_POST['extra'];
