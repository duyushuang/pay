...
class cacheData{
	...
	public static function cacheStart($file, $time = 3600, $suffix = '', $ignoreKey = false){
		...
		if ($html !== false) {
			...
			self::$cacheData[$key] = qscms::ob_get_contents();
			qscms::ob_clean();
			return true;
		}
	}
...
cacheData::$cacheDir  = d(qscms::getCfgPath('/system/cacheDirRoot+/system/cacheDirs/html').'tpl/');
file::createFolder(cacheData::$cacheDir);
