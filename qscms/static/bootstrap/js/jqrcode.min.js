	...
	var r = function() {
		...
		var t = function(t, e) {
			...
			p = function() {
				...
				e = 0; 8 > e; e += 1) {
					y(!0, e);
					var n = a.getLostPoint(m); (0 == e || r > n) && (r = n, t = e)
				}
				return t
			},
			B = function() {
			...
			M = function(r, t) {
				...
				o = 7,
				i = 0,
				u = a.getMaskFunction(t), f = v - 1; f > 0; f -= 2) for (6 == f && (f -= 1);;) {
			...
			C = function(t, e) {
				...
				for (var m = 0,
				s = 0; s < e.length; s += 1) m += e[s].totalCount;
			...
			D = function(r, t, e) {
				...
				for (var s = 0,
				l = 0; l < n.length; l += 1) s += n[l].dataCount;
			...
			m.createTableTag = function(r, t) {
				...
				for (var n = 0; n < m.getModuleCount(); n += 1) {
					e += "<tr>";
					for (var o = 0; o < m.getModuleCount(); o += 1) e += '<td style="',
					e += " border-width: 0px; border-style: none;",
					e += " border-collapse: collapse;",
		...
		a = function() {
			...
			f.getLostPoint = function(r) {
				...
				for (var l = 0,
				o = 0; t > o; o += 1) for (var n = 0; t > n; n += 1) r.isDark(n, o) && (l += 1);
		...
		u = function() {
			...
			return e.getRSBlocks = function(r, e) {
				...
				i = new Array,
				u = 0; a > u; u += 1) for (var f = n[3 * u + 0], c = n[3 * u + 1], l = n[3 * u + 2], g = 0; f > g; g += 1) i.push(t(c, l));
				return i
			},
			e
		} (),
		...
		v = function(r, t) {
			...
			u = function(r) {
				...
				for (s += 1; s < o.length;) {
					...
					s += 1,
					a.contains(v + h) ? v += h: (g.write(a.indexOf(v), n), a.size() < 4095 && (a.size() == 1 << n && (n += 1), a.add(v + h)), v = h)
				}
